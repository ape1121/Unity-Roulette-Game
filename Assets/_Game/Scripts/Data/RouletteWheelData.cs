...
namespace Ape.Data
{
    ...
    [CreateAssetMenu(fileName = "RouletteWheelData", menuName = "CriticalShot/Configs/Roulette Wheel Data")]
    public sealed class RouletteWheelData : ScriptableObject
    {
        [SerializeField] private GameConfig.WheelVisualTheme visualTheme = GameConfig.WheelVisualTheme.Bronze;
        ...
        public GameConfig.WheelVisualTheme VisualTheme => visualTheme;
